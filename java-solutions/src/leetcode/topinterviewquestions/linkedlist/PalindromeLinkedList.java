...
public class PalindromeLinkedList {
	...
	public static boolean isPalindromeStack(ListNode head) {
		...
		//two pointer method, secondHalf ends at the halfway point
		while (runner != null) {
			if (runner.next == null) {
				isOdd = true;
				break;
		...
		//if the linkedlist has an odd amount of nodes, account for it
		if (isOdd) {
			secondHalf = secondHalf.next;
		}
		
		//compare first half(stack) with second half of the linked list
		while (secondHalf != null) {
